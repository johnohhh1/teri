-- Truth Empowered Relationships Database Schema
-- Based on PRD.md Section 2.2 Data Models
...
-- ============================================================================
-- USERS TABLE - Individual user accounts with partner pairing
-- ============================================================================
CREATE TABLE users (
...
-- ============================================================================
-- COUPLES TABLE - Partner relationships with canonical ordering
-- ============================================================================
...
-- ============================================================================
-- SECTION PROGRESS TABLE - Training progress with gating logic
-- ============================================================================
...
-- Indexes for section_progress table
...
-- ============================================================================
-- TRANSLATOR SESSIONS TABLE - TES/TEL translation sessions
-- ============================================================================
...
-- Indexes for translator_sessions table
...
-- ============================================================================
-- MEDIATOR SESSIONS TABLE - Audio recording analysis sessions
-- ============================================================================
CREATE TABLE mediator_sessions (
    ...
    -- Example structure:
    -- {
    --   "outer": "Partner expressed frustration about tasks",
...
-- Indexes for mediator_sessions table
...
-- ============================================================================
-- JOURNAL ENTRIES TABLE - Personal and shared reflections
-- ============================================================================
...
-- ============================================================================
-- GAME SESSIONS TABLE - Relationship games and activities
-- ============================================================================
...
-- ============================================================================
-- COMPREHENSION QUESTIONS TABLE - Quiz questions for section completion
-- ============================================================================
...
-- Indexes for comprehension_questions table
...
-- ============================================================================
-- COMPREHENSION ATTEMPTS TABLE - Track quiz attempts and scores
-- ============================================================================
...
-- Indexes for comprehension_attempts table
...
-- Active couples with progress summary
...
-- Function to safely pair two users
...
-- Function to check and update section progression
...
-- Add any reference data or default values here
-- This could include initial comprehension questions, game definitions, etc.
...
-- Performance indexes (non-concurrent for Supabase)
